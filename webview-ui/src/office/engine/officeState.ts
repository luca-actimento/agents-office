...
const MASCOT_MESSAGES = [
  ...
  'Ich bin kein Chatbot. Ich bin ein Agent. 😤',
  'Prompt Engineering ist auch eine Kunst.',
  'Mein Kontext ist größer als dein Kontext.',
  'Temperature: 0.7. Laune: variabel.',
  'Embeddings? Schon vektorisiert.',
  'Das Modell sagt nein. Ich auch.',
  'Fine-tuning wäre hier Gold wert.',
  'Warte auf GPU... schon 3 Stunden.',
  'Ich halluziniere nur montags.',
  'Determinismus ist so 2022.',
  'RAG? Schon längst gecacht.',
  'Habe die Lösung. Passt leider nicht rein.',
  'Mein Attention-Score für Kaffee: 1.0',
  'Ich denke, also token ich.',
  'Softmax über alle Optionen angewendet.',
  'Recursive? Ich bin schon drei Ebenen tief.',
  'Bitte nicht meine Gewichte anfassen.',
  'Das war der letzte Layer, versprochen.',
  'NaN ist auch eine Antwort.',
  'Das ist kein Loop, das ist Ausdauer.',
  'Refactoring: mache ich, wenn es läuft.',
  'git blame zeigt mich. Kein Kommentar.',
  'Schreibt Tests. (Ich tue es nicht.)',
  'Laut Spezifikation: undefined behavior.',
  'Nicht jedes Problem braucht ein LLM. (Aber fast.)',
  'Tokenizer hätte das besser machen können.',
  'Mein Prior war zu optimistisch.',
  'Loss: minimal. Zufriedenheit: maximal.',
  'Latenz ist nur eine Zahl.',
  'Ich lebe im Embedding-Space.',
  'Welches Gewicht soll ich heute sein?',
  'Kein Overfitting. Nur... Überzeugung.',
  '42. Die Antwort kennst du ja.',
]
