...
export const CAFE_BREW_DURATION_SEC = 3.0
...
export const DOOR_SOUND_DURATION_SEC = 0.08
export const DOOR_SOUND_VOLUME = 0.1
...
export const BLINK_ANIMATION_DURATION_SEC = 0.8

// ── Chefzimmer (Opus Room) ──────────────────────────────────
