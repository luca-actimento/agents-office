...
function App() {
  ...
  return (
    <div ref={containerRef} style={{ width: '100%', height: '100%', position: 'relative', overflow: 'hidden' }}>
      <style>{`
        @keyframes agents-office-pulse {
          0%, 100% { opacity: 1; }
          50% { opacity: 0.3; }
        }
        .agents-office-pulse { animation: agents-office-pulse ${PULSE_ANIMATION_DURATION_SEC}s ease-in-out infinite; }
        @keyframes agents-office-blink {
          0%, 100% { opacity: 1; }
          50% { opacity: 0.15; }
        }
        .agents-office-blink { animation: agents-office-blink ${BLINK_ANIMATION_DURATION_SEC}s ease-in-out infinite; }
      `}</style>
      ...
      <OfficeCanvas
        ...
        onRotateFurnitureNormal={editor.handleRotateFurnitureNormal}
